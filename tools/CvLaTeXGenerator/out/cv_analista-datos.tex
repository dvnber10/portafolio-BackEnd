...
\cvitem{}{\small Ingeniero en Sistemas y Computación con experiencia profesional en pipelines de datos y proyectos de análisis de datos en entornos ágiles. Competente en SQL (MongoDB, MySQL, MS SQL Server), Python para procesamiento de audio y texto, preprocesamiento de datasets, métricas de evaluación de modelos y análisis exploratorio. En proceso de especialización en analítica y ciencia de datos en la Universidad de Cundinamarca. Reconocido por atención al detalle, autonomía en análisis de datos y trabajo colaborativo en equipos remotos.}

\section{Logros Destacados}

\cvitem{}{\small Preprocesamiento de datasets de audio y texto (Common Voice, VoxPopuli)}
\cvitem{}{\small Métricas de evaluación de modelos y análisis exploratorio (EDA)}
\cvitem{}{\small SQL y NoSQL: MongoDB, MySQL, MS SQL Server}
\cvitem{}{\small Specialización en analítica y ciencia de datos}
...
\cvitem{Habilidades}{\small Python (Librosa, Transformers, FastAPI) • SQL • MongoDB • MySQL • MS SQL Server • Preprocesamiento y limpieza de datos • EDA • Pandas • NumPy • Matplotlib • Extracción de características • Métricas de modelos • Hugging Face • Excel • Git/GitHub • Docker • Linux}
...
\cvitem{}{\small Análisis exploratorio de datos, preprocesamiento y limpieza de datos, bases de datos NoSQL/SQL, pipelines de datos, investigación aplicada y visualización de resultados.}
